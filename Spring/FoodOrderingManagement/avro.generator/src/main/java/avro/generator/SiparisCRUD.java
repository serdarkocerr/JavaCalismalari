...
public class SiparisCRUD {
	public int siparisId;
	public int anayemekId;
	public String anayemekAdi;
	public int corbaId;
	...
	public String toString() {
		return "SiparisCRUD [siparisId=" + siparisId + ", anayemekId=" + anayemekId + ", anayemekAdi=" + anayemekAdi
				+ ", corbaId=" + corbaId + ", corbaAdi=" + corbaAdi + ", salataId=" + salataId + ", salataAdi="
				+ salataAdi + ", tatliId=" + tatliId + ", tatliAdi=" + tatliAdi + ", masaId=" + masaId + ", masaAdi="
				+ masaAdi + ", kullaniciId=" + kullaniciId + ", kullaniciAdi=" + kullaniciAdi + ", kullaniciSoyadi="
				+ kullaniciSoyadi + ", kullaniciTurId=" + kullaniciTurId + ", kullaniciTurAdi=" + kullaniciTurAdi
				+ ", siparisDurumu=" + siparisDurumu + ", crudType=" + crudType + "]";
	}



	public SiparisCRUD(int siparisId, int anayemekId, String anayemekAdi, int corbaId, String corbaAdi, int salataId,
			String salataAdi, int tatliId, String tatliAdi, int masaId, String masaAdi, int kullaniciId,
			String kullaniciAdi, String kullaniciSoyadi, int kullaniciTurId, String kullaniciTurAdi,
			String siparisDurumu, CRUDType crudType) {
		super();
		this.siparisId = siparisId;
		this.anayemekId = anayemekId;
		this.anayemekAdi = anayemekAdi;
