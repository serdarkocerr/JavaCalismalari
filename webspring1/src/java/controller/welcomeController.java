...
public class welcomeController extends AbstractController {
    ...
    */
    ...
    protected ModelAndView handleRequestInternal(
            ...
            System.out.println(" welcomeController'a gelen request icindeki page bilgisi : " + page);
             ModelAndView mw = new ModelAndView(page);//sayfanin adi olur. welcome.jsp "welcome"
             
             mw.addObject("message", "Mesaj welcomeController");
             
             System.out.println("controller.welcomeController.handleRequestInternal() --- WELCOME CONTROLLER");
             return mw;
    }
