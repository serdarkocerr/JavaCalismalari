...
public class Kullanici extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static tr.com.siparis.sistemi.kafka.model.Kullanici.Builder newBuilder() {
    return new tr.com.siparis.sistemi.kafka.model.Kullanici.Builder();
  }
  
  /** Creates a new Kullanici RecordBuilder by copying an existing Builder */
  public static tr.com.siparis.sistemi.kafka.model.Kullanici.Builder newBuilder(tr.com.siparis.sistemi.kafka.model.Kullanici.Builder other) {
    return new tr.com.siparis.sistemi.kafka.model.Kullanici.Builder(other);
  }
  
  /** Creates a new Kullanici RecordBuilder by copying an existing Kullanici instance */
  public static tr.com.siparis.sistemi.kafka.model.Kullanici.Builder newBuilder(tr.com.siparis.sistemi.kafka.model.Kullanici other) {
    return new tr.com.siparis.sistemi.kafka.model.Kullanici.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Kullanici>
    ...
    private Builder(tr.com.siparis.sistemi.kafka.model.Kullanici other) {
            super(tr.com.siparis.sistemi.kafka.model.Kullanici.SCHEMA$);
      if (isValidValue(fields()[0], other.kullaniciTur_id)) {
        this.kullaniciTur_id = data().deepCopy(fields()[0].schema(), other.kullaniciTur_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'kullaniciTur_id' field */
    public tr.com.siparis.sistemi.kafka.model.Kullanici.Builder setKullaniciTurId(int value) {
    ...
    public tr.com.siparis.sistemi.kafka.model.Kullanici.Builder clearKullaniciTurId() {
    ...
    public tr.com.siparis.sistemi.kafka.model.Kullanici.Builder clearKullaniciAdi() {
      kullanici_adi = null;
    ...
    /** Sets the value of the 'kullanici_id' field */
    public tr.com.siparis.sistemi.kafka.model.Kullanici.Builder setKullaniciId(int value) {
    ...
    public tr.com.siparis.sistemi.kafka.model.Kullanici.Builder clearKullaniciId() {
    ...
    /** Sets the value of the 'kullanici_soyadi' field */
    public tr.com.siparis.sistemi.kafka.model.Kullanici.Builder setKullaniciSoyadi(java.lang.CharSequence value) {
